  ...
  return (
    ...
    <div className="links-container">
      <div className="leetcode-container link">
        <img src="/personal-portfolio/public/images/leetcode.jpg" alt="" />
      ...
      <div className="github-container link">
        <img src="/personal-portfolio/public/images/twitter.jpg" alt="" />
        <div className="link-text-container">
      ...
      <div className="twitter-container link">
        <img src="/personal-portfolio/public/images/linkedin.png" alt="" />
        <div className="link-text-container">
      ...
      <div className="LinkedIn-container link">
        <img src="/personal-portfolio/public/images/github.png" alt="" />
        <div className="link-text-container">
